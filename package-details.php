...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<input type="date" name="fromdate" placeholder="dd-mm-yyyy"    required="">
			</div>
			<div class="bnr-right">
				<label class="inputLabel">To</label>
				<input type="date" name="todate" placeholder="dd-mm-yyyy"   required="">
			</div>
			
			<div class="bnr-right">
				<label class="inputLabel">Member</label>
				<input class="integer" id='id1' type="number" min="1" value="1" placeholder="Enter Total member" required="">
				<button style = "margin-top :10px" onclick="gfg_Run()">
			...
			<div>
				...
				<div class="grand">
					<p>Grand Total</p>
					<h3 id="idd" style="color:red"><?php echo htmlentities($result->PackagePrice);?></h3>
				</div>
...
<script>
        ...
        function gfg_Run() {
             var x = inputF.value;
			 document.getElementById("idd").innerHTML= "₹ " + x*y;
        }
